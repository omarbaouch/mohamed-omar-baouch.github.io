...
// modification vient de article:published_time quand la page en déclare une,
...
const urls = pages.map((file) => {
  ...
  const lastmod = publie ? publie.slice(0, 10) : statSync(abs).mtime.toISOString().slice(0, 10);
