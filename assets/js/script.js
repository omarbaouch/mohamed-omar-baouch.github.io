...
const translations = {
    fr: {
        ...
        "project_types_title": "100+ projets par type d'intervention",
    ...
    en: {
        ...
        "stat_diagnostic": "100+ projects",
        "stat_diagnostic_desc": "Delivered since 2020",
        "stat_deployments": "20+ deployments",
        ...
        "project_types_title": "100+ projects by type of intervention",
    ...
    fr: {
        ...
        articles: {
            ...
            "nomenclature-bom-pdm-plm-erp": {
                ...
                blog_bom_s7_p1: "Après 80+ clients et 100+ projets PDM, voici les symptômes récurrents que j'observe quand PDM, PLM et ERP ne parlent pas le même langage :",
            ...
            "migration-donnees-solidworks-pdm": {
                blog_migration_badge_type: "SOLIDWORKS PDM",
                blog_migration_hero_eyebrow: "Migration &amp; reprise de données",
                blog_migration_hero_title: "Migration de données vers SOLIDWORKS PDM : le guide terrain pour réussir sans perdre un fichier",
                blog_migration_hero_subtitle: `Publié le <span data-date-iso="2026-03-18T00:00:00.000Z" data-date-format="long">18 mars 2026</span> — méthodologie complète, pièges courants et retours d'expérience après 80+ migrations industrielles.`,
                blog_migration_stat_publication: "Date de publication",
                blog_migration_stat_phases: "Phases de migration",
                blog_migration_stat_projects: "Projets réalisés",
                blog_migration_hero_figcaption: "Migrer vers un coffre-fort PDM, c'est passer du chaos organisé sur un serveur de fichiers à une architecture de données tracée, versionnée et sécurisée.",
                blog_migration_summary_label1: "Pourquoi migrer vers un PDM ?",
                blog_migration_summary_meta1: "Les douleurs du serveur de fichiers",
                blog_migration_summary_label2: "Phase 1 : Auditer l'existant",
                blog_migration_summary_meta2: "Cartographie, nommage, références orphelines",
                blog_migration_summary_label3: "Phase 2 : Définir la stratégie de reprise",
                blog_migration_summary_meta3: "Big bang, progressif, ou hybride ?",
                blog_migration_summary_label4: "Phase 3 : Nettoyer et préparer les données",
                blog_migration_summary_meta4: "Renommage, doublons, références cassées",
                blog_migration_summary_label5: "Phase 4 : La migration technique",
                blog_migration_summary_meta5: "Outils, jeu de test, validation",
                blog_migration_summary_label6: "Phase 5 : Former et basculer",
                blog_migration_summary_meta6: "Accompagnement humain et jour J",
                blog_migration_summary_label7: "Phase 6 : Stabiliser et optimiser",
                blog_migration_summary_meta7: "Support, indicateurs, amélioration continue",
                blog_migration_summary_label8: "Les 7 erreurs que je vois sur chaque projet",
                blog_migration_summary_meta8: "Et comment les éviter",
                blog_migration_s1_title: "1. Pourquoi migrer vers un PDM ?",
                blog_migration_s1_p1: "La majorité des bureaux d'études industriels que j'accompagne fonctionnent encore avec un <strong>serveur de fichiers Windows</strong> : une arborescence de dossiers, une convention de nommage plus ou moins respectée, et un tableur Excel qui tient lieu de « système de gestion ». Ça fonctionne — jusqu'au jour où ça ne fonctionne plus.",
                blog_migration_s1_p2: "Le point de bascule arrive toujours au même moment : quand un dessinateur écrase le travail d'un collègue, quand une ancienne révision part en production, ou quand le directeur technique réalise qu'il ne sait pas où en sont les plans du produit livré il y a 6 mois.",
                blog_migration_s1_quote: "Chez un fabricant de machines spéciales, l'équipe BE de 12 personnes perdait en moyenne 45 minutes par jour à chercher « la bonne version » d'un fichier. Multiplié par 12 personnes, 220 jours ouvrables — c'est l'équivalent de 2,5 postes à temps plein perdus chaque année dans de la non-valeur.",
                blog_migration_s1_card1_title: "Douleurs du serveur de fichiers",
                blog_migration_s1_card1_item1: "Aucun verrouillage : deux personnes modifient le même fichier en même temps",
                blog_migration_s1_card1_item2: "Pas de versionnement : les copies « v2_final_VRAI_def » pullulent",
                blog_migration_s1_card1_item3: "Références cassées : un fichier déplacé = un assemblage SOLIDWORKS cassé",
                blog_migration_s1_card1_item4: "Aucune traçabilité : qui a modifié quoi, quand, pourquoi ?",
                blog_migration_s1_card1_item5: "Sauvegarde fragile : un ransomware et tout disparaît",
                blog_migration_s1_card2_title: "Ce qu'apporte SOLIDWORKS PDM",
                blog_migration_s1_card2_item1: "Check-in / Check-out : un seul utilisateur modifie à la fois",
                blog_migration_s1_card2_item2: "Versionnement automatique avec historique complet",
                blog_migration_s1_card2_item3: "Coffre-fort SQL : intégrité référentielle garantie",
                blog_migration_s1_card2_item4: "Workflows d'approbation : validation tracée et conforme",
                blog_migration_s1_card2_item5: "Réplicas et sauvegardes intégrées : continuité d'activité",
                blog_migration_s2_title: "2. Phase 1 : Auditer l'existant",
                blog_migration_s2_p1: "<strong>Ne jamais faire confiance aux données existantes.</strong> C'est mon principe n°2, et c'est la raison pour laquelle chaque migration commence par un audit exhaustif. L'objectif : dresser une cartographie précise de ce qui existe, dans quel état, et avec quelles dépendances.",
                blog_migration_s2_p2: "Un audit bien mené répond à quatre questions : combien de fichiers ? Quels formats ? Quelles conventions de nommage ? Et surtout : quelles sont les références orphelines — ces fichiers pointés par des assemblages mais qui n'existent plus ou ont été déplacés ?",
                blog_migration_s2_table_h_point: "Point de contrôle",
                blog_migration_s2_table_h_question: "Question clé",
                blog_migration_s2_table_h_tool: "Outil / Méthode",
                blog_migration_s2_table_h_risk: "Risque si ignoré",
                blog_migration_s2_row1_point: "<strong>Volume</strong>",
                blog_migration_s2_row1_question: "Combien de fichiers CAO, PDF, Office ?",
                blog_migration_s2_row1_tool: "Script PowerShell / TreeSize",
                blog_migration_s2_row1_risk: "Sous-estimation du périmètre, planning explosé",
                blog_migration_s2_row2_point: "<strong>Nommage</strong>",
                blog_migration_s2_row2_question: "Y a-t-il une convention ? Est-elle respectée ?",
                blog_migration_s2_row2_tool: "Regex + revue manuelle",
                blog_migration_s2_row2_risk: "Numéros de série en doublon dans le coffre-fort",
                blog_migration_s2_row3_point: "<strong>Références</strong>",
                blog_migration_s2_row3_question: "Quels assemblages pointent vers des fichiers manquants ?",
                blog_migration_s2_row3_tool: "SOLIDWORKS → Ouvrir en lecture seule + vérifier",
                blog_migration_s2_row3_risk: "Assemblages cassés dans le PDM dès le jour 1",
                blog_migration_s2_row4_point: "<strong>Doublons</strong>",
                blog_migration_s2_row4_question: "Mêmes pièces stockées à plusieurs endroits ?",
                blog_migration_s2_row4_tool: "Comparaison hash MD5 / nom + taille",
                blog_migration_s2_row4_risk: "Conflits de version post-migration",
                blog_migration_s2_row5_point: "<strong>Métadonnées</strong>",
                blog_migration_s2_row5_question: "Les propriétés SOLIDWORKS sont-elles renseignées ?",
                blog_migration_s2_row5_tool: "#TASK ou macro VBA d'extraction",
                blog_migration_s2_row5_risk: "Cartes de données PDM vides, recherche impossible",
                blog_migration_s2_callout: "En moyenne, sur 80+ audits que j'ai réalisés, <strong>15 à 30 % des fichiers</strong> présentent au moins une anomalie (doublon, référence cassée, nommage non conforme). Ignorer cette phase, c'est importer le chaos dans un système conçu pour l'ordre.",
                blog_migration_s3_title: "3. Phase 2 : Définir la stratégie de reprise",
                blog_migration_s3_p1: "C'est la décision la plus structurante du projet. Trois approches existent, chacune avec ses avantages et ses contraintes. Le choix dépend du volume de données, de la maturité de l'équipe et de la tolérance à l'arrêt de production du BE.",
                blog_migration_s3_card1_title: "Big Bang",
                blog_migration_s3_card1_item1: "<strong>Principe :</strong> tout migrer d'un coup, un week-end ou pendant un arrêt",
                blog_migration_s3_card1_item2: "<strong>Avantage :</strong> pas de double-système, transition nette",
                blog_migration_s3_card1_item3: "<strong>Risque :</strong> si ça plante, tout le monde est bloqué lundi matin",
                blog_migration_s3_card1_item4: "<strong>Idéal pour :</strong> < 50 000 fichiers, équipe < 10 personnes",
                blog_migration_s3_card2_title: "Progressif (par lot)",
                blog_migration_s3_card2_item1: "<strong>Principe :</strong> migrer projet par projet ou famille par famille",
                blog_migration_s3_card2_item2: "<strong>Avantage :</strong> risque maîtrisé, apprentissage itératif",
                blog_migration_s3_card2_item3: "<strong>Risque :</strong> double-système pendant des semaines/mois",
                blog_migration_s3_card2_item4: "<strong>Idéal pour :</strong> > 100 000 fichiers, équipe > 20 personnes",
                blog_migration_s3_card3_title: "Hybride (mon approche préférée)",
                blog_migration_s3_card3_item1: "<strong>Principe :</strong> migrer les projets actifs en Big Bang, puis ingérer l'historique progressivement",
                blog_migration_s3_card3_item2: "<strong>Avantage :</strong> le BE travaille dans le PDM dès le jour 1, l'historique suit sans pression",
                blog_migration_s3_card3_item3: "<strong>Risque :</strong> nécessite une gestion fine des références croisées actif/historique",
                blog_migration_s3_card3_item4: "<strong>Idéal pour :</strong> la majorité des PME/ETI industrielles",
                blog_migration_s3_card4_title: "Critères de choix",
                blog_migration_s3_card4_item1: "Volume total de fichiers CAO",
                blog_migration_s3_card4_item2: "Nombre d'utilisateurs simultanés",
                blog_migration_s3_card4_item3: "Tolérance à l'arrêt du BE",
                blog_migration_s3_card4_item4: "Complexité des références inter-projets",
                blog_migration_s3_quote: "Sur un projet industriel, on a migré 180 000 fichiers en approche hybride : les 3 projets en cours d'étude ont basculé un vendredi soir, et l'historique (12 ans de données) a été ingéré progressivement sur 3 semaines. Le lundi matin, les 15 dessinateurs travaillaient dans le coffre-fort. Zéro temps mort.",
                blog_migration_s4_title: "4. Phase 3 : Nettoyer et préparer les données",
                blog_migration_s4_p1: "C'est la phase la plus ingrate — et la plus critique. Migrer des données sales dans un coffre-fort PDM, c'est exactement comme déménager dans un appartement neuf en emportant toutes les boîtes non triées du grenier. Le désordre vous suit.",
                blog_migration_s4_p2: "Le nettoyage se fait en trois passes : <strong>correction des références</strong> (fichiers déplacés ou renommés qui cassent les assemblages), <strong>élimination des doublons</strong> (même pièce stockée dans 3 dossiers différents), et <strong>enrichissement des métadonnées</strong> (remplir les propriétés SOLIDWORKS pour alimenter les cartes de données PDM).",
                blog_migration_s4_card1_title: "Outils de nettoyage",
                blog_migration_s4_card1_item1: "<strong>#TASK :</strong> automatisation en masse des propriétés fichier",
                blog_migration_s4_card1_item2: "<strong>SOLIDWORKS Utilities :</strong> détection de doublons géométriques",
                blog_migration_s4_card1_item3: "<strong>Scripts PowerShell :</strong> renommage en masse, correction de chemins",
                blog_migration_s4_card1_item4: "<strong>Pack & Go :</strong> repackaging d'assemblages avec références corrigées",
                blog_migration_s4_card2_title: "Règles d'or",
                blog_migration_s4_card2_item1: "Ne jamais nettoyer sur les données de production — toujours travailler sur une copie",
                blog_migration_s4_card2_item2: "Valider chaque lot avec le BE avant de passer au suivant",
                blog_migration_s4_card2_item3: "Documenter chaque règle de renommage (l'équipe doit pouvoir retracer)",
                blog_migration_s4_card2_item4: "Prévoir un « bac à sable » pour les fichiers inclassables",
                blog_migration_summary_label4b: "Dans les coulisses : ma boîte à outils terrain",
                blog_migration_summary_meta4b: "DataRecovery, FindDocuments, Dependencies, flux de synchronisation",
                blog_migration_s4b_title: "Dans les coulisses : ma boîte à outils terrain",
                blog_migration_s4b_p1: "La théorie c'est bien, mais ce qui fait la différence entre une migration qui réussit et une qui déraille, ce sont les outils et les automatismes. Voici concrètement ce que j'utilise sur le terrain, étape par étape. Chaque outil a un rôle précis dans la chaîne — sauter une étape, c'est prendre le risque de contaminer tout le coffre-fort.",
                blog_migration_s4b_table_h_etape: "Étape",
                blog_migration_s4b_table_h_outil: "Outil",
                blog_migration_s4b_table_h_action: "Ce qu'il fait",
                blog_migration_s4b_table_h_resultat: "Résultat concret",
                blog_migration_s4b_row1_action: "Copie les fichiers Windows dans le coffre PDM et extrait les propriétés SOLIDWORKS en masse dans un fichier Excel",
                blog_migration_s4b_row1_resultat: "Un fichier Excel avec tous les chemins, références internes (REF_INT), indices de révision et types de fichiers",
                blog_migration_s4b_row2_action: "Analyse automatique : extraction de la REF_INT, détection de la dernière révision, identification des doublons, indices invalides et contamination de groupe",
                blog_migration_s4b_row2_resultat: "Chaque fichier classé en 3 catégories : <strong>OUI</strong> (renommer), <strong>NON</strong> (archiver), <strong>ALERTE</strong> (traitement manuel)",
                blog_migration_s4b_row3_action: "Construit une base SQLite de tous les documents SOLIDWORKS et renomme en masse <strong>en dehors du coffre</strong>, sans casser les liens de références — indispensable sur PDM Standard où l'API ne permet pas le renommage dans le coffre",
                blog_migration_s4b_row3_resultat: "Tous les fichiers RENOMMAGE=OUI renommés avec leur REF_INT avant injection dans le coffre, liens intacts entre assemblages et pièces",
                blog_migration_s4b_row4_action: "Détecte et liste les vrais doublons dans le coffre-fort (même référence + même indice)",
                blog_migration_s4b_row4_resultat: "Liste nettoyée, suppression des doublons avant de passer à la restauration des liens",
                blog_migration_s4b_row5_action: "Analyse et corrige les références rompues dans les assemblages SOLIDWORKS — cherche le fichier dans le coffre et rétablit le lien",
                blog_migration_s4b_row5_resultat: "Zéro croix rouge à l'ouverture des assemblages. À relancer une 2e fois pour vérifier",
                blog_migration_s4b_row6_action: "Transition automatique dans le workflow PDM : synchronise le compteur de révision avec l'indice renseigné dans la carte (A→B→C…Z)",
                blog_migration_s4b_row6_resultat: "Historique de versions cohérent dans le coffre-fort, chaque fichier à son bon indice",
                blog_migration_s4b_row7_action: "Renommage en masse <strong>directement dans le coffre-fort</strong> via l'API PDM — disponible uniquement sur PDM Professional. Chaîne plusieurs actions (numéros de série, renommage, conversion, tamponnage) lors des transitions de workflow",
                blog_migration_s4b_row7_resultat: "Renommage piloté par les variables de carte, avec génération automatique de référence unique (SmartCounter)",
                blog_migration_s4b_quote: "Sur un projet de migration depuis 3DEXPERIENCE vers SOLIDWORKS PDM, le défi : les noms de fichiers dans 3DX ne correspondaient pas aux noms physiques. On a dû construire une table de correspondance via le Part Number comme clé de liaison. DataRecovery extrait les chemins PDM, on croise avec la nomenclature 3DX, et le fichier Excel génère automatiquement les bons chemins pour l'injection des propriétés. Sans cette étape, on aurait attribué les mauvaises métadonnées à des centaines de fichiers.",
                blog_migration_s4b_p2: "Le point crucial que je veux souligner : <strong>ces outils ne sont pas optionnels.</strong> Chaque étape de la chaîne produit le livrable nécessaire à l'étape suivante. DataRecovery alimente le fichier Excel d'analyse, qui pilote FindDocuments, qui prépare le terrain pour Dependencies. Sauter une étape — par exemple renommer sans avoir analysé — c'est contaminer toute la suite. J'ai vu des migrations reprises de zéro parce que le nettoyage avait été bâclé.",
                blog_migration_s4b_callout: "Sur un projet de reprise, le fichier Excel d'analyse a classé automatiquement chaque fichier en trois catégories : <strong>OUI</strong> (dernière révision valide, à renommer avec la REF_INT), <strong>NON</strong> (ancienne révision, à archiver), et <strong>ALERTE</strong> (référence invalide, doublon ou indice non conforme — traitement manuel). Ce tri automatisé a permis de traiter 95 % des fichiers sans intervention humaine. Seuls les 5 % en ALERTE ont nécessité un examen au cas par cas — vérification du cas d'emploi, correction de la carte, puis archivage ou renommage.",
                blog_migration_s4b_rev_title: "Focus : comment on récupère et synchronise les indices de révision",
                blog_migration_s4b_rev_p1: "C'est la question que tout le monde pose — et celle où la plupart des migrations déraillent. Quand un fichier s'appelle <code>SPF-AC8602-Piece-B.SLDPRT</code>, le \"B\" en fin de nom est l'indice de révision. On ne le devine pas : on l'<strong>extrait</strong>, soit depuis le nom de fichier (pattern de type <code>XXX-LLnnnn-Nom-INDICE.ext</code>), soit depuis une propriété personnalisée SOLIDWORKS (métadonnée \"Revision\" ou \"Indice\" dans la carte). Dans les deux cas, c'est le fichier Excel d'analyse qui fait le travail d'extraction.",
                blog_migration_s4b_rev_p2: "<strong>Règle fondamentale : on ne migre activement que la dernière révision.</strong> Si pour une même référence <code>SPF-AC8602</code> il existe les fichiers A, B et C, seul le fichier à l'indice C sera renommé et intégré comme document actif dans le coffre-fort (catégorie <strong>OUI</strong>). Les fichiers A et B sont conservés mais envoyés en état <strong>ARCHIVE</strong> dans le workflow PDM — ils restent accessibles pour l'historique, mais ne polluent pas l'espace de travail courant.",
                blog_migration_s4b_rev_extract_title: "Extraction de l'indice",
                blog_migration_s4b_rev_extract1: "<strong>Depuis le nom :</strong> le script Excel parse le nom du fichier et isole la lettre (A-Z) en dernière position avant l'extension",
                blog_migration_s4b_rev_extract2: "<strong>Depuis les métadonnées :</strong> DataRecovery lit la propriété \"Revision\" ou \"Indice\" dans les propriétés personnalisées SOLIDWORKS",
                blog_migration_s4b_rev_extract3: "<strong>Cas des plans (SLDDRW) :</strong> le plan hérite de la REF_INT et de l'indice de son modèle 3D associé (même nom de fichier). Si aucun 3D n'est trouvé, extraction directe depuis le nom du plan",
                blog_migration_s4b_rev_sync_title: "Synchronisation dans PDM",
                blog_migration_s4b_rev_sync1: "<strong>Transition \"VALIDER REPRISE\" :</strong> une transition spéciale est configurée dans le workflow PDM pour caler le compteur de révision",
                blog_migration_s4b_rev_sync2: "<strong>Passe par indice :</strong> on exécute la transition pour les fichiers à l'indice A (incrément = 0), puis B (incrément = 1), puis C (incrément = 2)… jusqu'à Z",
                blog_migration_s4b_rev_sync3: "<strong>Résultat :</strong> le compteur interne PDM correspond exactement à l'indice réel du fichier — la montée d'indice fonctionnera normalement ensuite",
                blog_migration_s4b_rev_callout: "<strong>Cas particulier — migration Workgroup vers PDM :</strong> les fichiers avec des révisions \"$\" ou \"$+\" (notation Workgroup) restent avec ces valeurs dans PDM. Au premier passage en état \"MODIFICATION AVEC INDICE\", ils basculent automatiquement en \"A\". Les fichiers déjà en A/B/C sont calés sur leur indice et évoluent normalement. Les révisions intermédiaires (\"A+\", \"B+\") nécessitent un traitement manuel pour être recalées proprement avant la montée d'indice standard.",
                blog_migration_s4b_dup_title: "Focus : la gestion des doublons — le poison silencieux d'une migration",
                blog_migration_s4b_dup_p1: "Les doublons sont le problème le plus sous-estimé dans une migration. Un doublon, c'est un fichier avec la <strong>même référence (REF_INT) + même type + même indice</strong> qui existe à plusieurs endroits. Sur certains projets, j'ai vu plus de <strong>40 000 doublons</strong> dans un seul coffre-fort — souvent générés par des copies d'arborescence mal configurées ou des renommages manuels approximatifs accumulés sur des années.",
                blog_migration_s4b_dup_p2: "Le problème n'est pas seulement l'espace disque. Un doublon crée de l'<strong>ambiguïté</strong> : quel fichier est le bon ? Celui dans le dossier \"Projet_2023\" ou celui dans \"Archive_ancien\" ? L'assemblage pointe vers lequel des deux ? Sans traitement, on importe le chaos dans le coffre-fort — et on le multiplie.",
                blog_migration_s4b_dup_detect_title: "Détection avec PDMreport",
                blog_migration_s4b_dup_detect1: "<strong>Rapport de doublons :</strong> PDMreport (via myPDMtools) génère un rapport CSV listant tous les fichiers dupliqués — même référence, même indice, emplacements différents",
                blog_migration_s4b_dup_detect2: "<strong>Analyse par lot :</strong> on traite dossier par dossier, en commençant par les dossiers d'import. Chaque doublon est examiné : date de création, dernière modification, références entrantes",
                blog_migration_s4b_dup_detect3: "<strong>Règle :</strong> on conserve toujours la version la plus récente et on vérifie l'intégrité des références après chaque suppression",
                blog_migration_s4b_dup_prevent_title: "Prévention post-migration",
                blog_migration_s4b_dup_prevent1: "<strong>Paramètre PDM :</strong> activer l'interdiction des noms de fichiers dupliqués dans les paramètres du coffre-fort — c'est la première chose à faire après la migration",
                blog_migration_s4b_dup_prevent2: "<strong>Copie d'arborescence :</strong> configurer des filtres d'exclusion (bibliothèque de pièces standards, composants achetés) pour éviter que chaque nouveau projet duplique les mêmes pièces",
                blog_migration_s4b_dup_prevent3: "<strong>Renommage automatique :</strong> coupler TaskActions + SmartCounter pour que chaque nouveau fichier reçoive automatiquement une référence unique — zéro saisie manuelle, zéro doublon",
                blog_migration_s4b_dup_callout: "<strong>Ordre critique :</strong> la suppression des doublons doit impérativement se faire <strong>après</strong> le renommage (FindDocuments) et <strong>avant</strong> la restauration des liens (Dependencies). Pourquoi ? Parce que si vous corrigez les références alors que des doublons existent encore, Dependencies risque de pointer vers le mauvais fichier. Et une fois le lien créé, il est beaucoup plus coûteux à corriger. La séquence renommer → dédoublonner → restaurer les liens n'est pas un détail méthodologique, c'est un verrou de qualité.",
                blog_migration_s4b_rename_title: "Focus : renommage en masse — dans le coffre ou en dehors ?",
                blog_migration_s4b_rename_p1: "C'est une question que je reçois systématiquement : <em>\"on peut renommer directement dans le coffre ?\"</em> La réponse dépend de votre version de PDM. C'est un point souvent mal compris, et il conditionne toute la stratégie de reprise.",
                blog_migration_s4b_rename_pro_title: "PDM Professional — renommage dans le coffre",
                blog_migration_s4b_rename_pro1: "<strong>API disponible :</strong> PDM Professional dispose d'une API de programmation complète qui autorise le renommage des fichiers directement dans le coffre-fort, sans extraire ni réimporter",
                blog_migration_s4b_rename_pro2: "<strong>TaskActions (myPDMtools) :</strong> permet de chaîner des actions lors des transitions de workflow — génération de numéros de série (SmartCounter), renommage automatique basé sur les variables de carte, conversion, tamponnage PDF",
                blog_migration_s4b_rename_pro3: "<strong>Avantage :</strong> le renommage se fait sur des fichiers déjà dans le coffre, avec mise à jour automatique de toutes les références PDM. Pas de risque de désynchronisation",
                blog_migration_s4b_rename_std_title: "PDM Standard — renommage en dehors du coffre",
                blog_migration_s4b_rename_std1: "<strong>Pas d'API :</strong> sur PDM Standard, l'API PDM n'est pas disponible. Les outils comme myPDMtools (TaskActions) ne fonctionnent pas — impossible de renommer dans le coffre via script",
                blog_migration_s4b_rename_std2: "<strong>FindDocuments (mycadtools) :</strong> la solution consiste à construire une base SQLite de tous les documents SOLIDWORKS <em>avant</em> de les copier dans le coffre. FindDocuments renomme en masse en mettant à jour les liens de références internes — sans casser un seul assemblage",
                blog_migration_s4b_rename_std3: "<strong>Séquence :</strong> on renomme d'abord sur le système de fichiers local, puis on injecte dans le coffre les fichiers déjà propres. Le coffre reçoit des données prêtes à l'emploi",
                blog_migration_s4b_rename_callout: "<strong>En résumé :</strong> avec <strong>PDM Professional</strong>, on renomme dans le coffre grâce à l'API (TaskActions + SmartCounter). Avec <strong>PDM Standard</strong>, on renomme en dehors du coffre avec FindDocuments (base SQLite) avant d'injecter les fichiers. Dans les deux cas, l'objectif est identique : chaque fichier porte sa bonne référence, et aucun lien d'assemblage n'est cassé. Le choix de l'outil dépend de votre licence — pas de la méthodologie.",
                blog_migration_s5_title: "5. Phase 4 : La migration technique",
                blog_migration_s5_p1: "C'est le moment où les données quittent le serveur de fichiers pour entrer dans le coffre-fort PDM. Cette phase est purement technique, mais elle doit être exécutée avec une précision chirurgicale. Un fichier oublié ou une référence mal résolue, et c'est un assemblage qui s'ouvre avec des croix rouges le lundi matin.",
                blog_migration_s5_p2: "La clé : <strong>toujours faire un essai à blanc.</strong> Je sélectionne un jeu de test représentatif (3 à 5 projets couvrant différents types d'assemblages, tailles, complexités) et je les migre dans un coffre-fort de test. L'équipe valide. Si tout est vert, on lance la migration de production.",
                blog_migration_s5_table_h_etape: "Étape",
                blog_migration_s5_table_h_action: "Action",
                blog_migration_s5_table_h_validation: "Validation",
                blog_migration_s5_row1_action: "Créer l'arborescence cible dans le coffre-fort",
                blog_migration_s5_row1_validation: "Structure conforme au cahier des charges",
                blog_migration_s5_row2_action: "Migrer le jeu de test (3-5 projets)",
                blog_migration_s5_row2_validation: "Ouverture des assemblages sans erreur",
                blog_migration_s5_row3_action: "Validation par l'équipe BE sur le jeu de test",
                blog_migration_s5_row3_validation: "PV de validation signé",
                blog_migration_s5_row4_action: "Migration de production (hors heures ouvrées)",
                blog_migration_s5_row4_validation: "Comptage fichiers source = fichiers cible",
                blog_migration_s5_row5_action: "Vérification post-migration : références, métadonnées, workflows",
                blog_migration_s5_row5_validation: "Checklist de 20 points de contrôle",
                blog_migration_s5_row6_action: "Couper l'accès au serveur de fichiers source",
                blog_migration_s5_row6_validation: "Aucun retour arrière silencieux possible",
                blog_migration_s5_callout: "Point critique : l'étape 6 fait peur, mais c'est indispensable. Si vous laissez l'ancien serveur accessible, les utilisateurs retourneront discrètement dans leurs vieilles habitudes. <strong>On ne peut pas être à moitié dans un PDM.</strong>",
                blog_migration_s6_title: "6. Phase 5 : Former et basculer",
                blog_migration_s6_p1: "C'est là que 80 % des projets PDM se jouent — et où la plupart échouent. Une migration techniquement parfaite ne vaut rien si les utilisateurs ne comprennent pas le « pourquoi » et le « comment » du nouveau système. L'humain avant l'outil, toujours.",
                blog_migration_s6_card1_title: "Formation des administrateurs",
                blog_migration_s6_card1_item1: "En amont de la migration (2-3 semaines avant)",
                blog_migration_s6_card1_item2: "Architecture du coffre-fort, workflows, permissions",
                blog_migration_s6_card1_item3: "Résolution des problèmes courants (fichiers bloqués, états incohérents)",
                blog_migration_s6_card1_item4: "Les former sur LEURS données, pas sur un jeu générique",
                blog_migration_s6_card2_title: "Formation des utilisateurs",
                blog_migration_s6_card2_item1: "Le jour même ou le lendemain de la bascule",
                blog_migration_s6_card2_item2: "Check-in, Check-out, recherche, changement d'état",
                blog_migration_s6_card2_item3: "Ateliers pratiques sur leurs projets réels",
                blog_migration_s6_card2_item4: "Documentation rapide : fiche réflexe A4 plastifiée",
                blog_migration_s6_quote: "Le dessinateur réticent, c'est mon histoire fétiche. Un senior de 25 ans d'expérience qui refusait catégoriquement de « mettre ses fichiers dans une boîte noire ». Je lui ai montré une seule chose : taper 3 lettres dans la recherche PDM et retrouver un plan en 2 secondes, là où il ouvrait 6 sous-dossiers pendant 3 minutes. Il est devenu le plus grand ambassadeur du projet.",
                blog_migration_s7_title: "7. Phase 6 : Stabiliser et optimiser",
                blog_migration_s7_p1: "Les 30 premiers jours post-migration sont critiques. C'est là que les mauvaises habitudes tentent de revenir, que les questions s'accumulent, et que les petits irritants peuvent se transformer en rejet massif si personne n'est là pour les traiter.",
                blog_migration_s7_card1_title: "Semaines 1-2 : Support intensif",
                blog_migration_s7_card1_item1: "Présence sur site ou en visio quotidienne",
                blog_migration_s7_card1_item2: "Traitement des tickets en < 2h",
                blog_migration_s7_card1_item3: "Ajustement des workflows si besoin",
                blog_migration_s7_card1_item4: "Débriefing quotidien avec l'admin PDM",
                blog_migration_s7_card2_title: "Semaines 3-4 : Autonomisation",
                blog_migration_s7_card2_item1: "L'admin PDM prend le relais en première ligne",
                blog_migration_s7_card2_item2: "Indicateurs de suivi : taux d'adoption, fichiers non archivés",
                blog_migration_s7_card2_item3: "Session de retour d'expérience avec l'équipe",
                blog_migration_s7_card2_item4: "Feuille de route d'optimisation (phase 2 : intégration ERP, dispatch…)",
                blog_migration_s8_title: "8. Les 7 erreurs que je vois sur chaque projet",
                blog_migration_s8_p1: "Après 80+ projets de migration, certains patterns reviennent systématiquement. Ce sont rarement des problèmes techniques — ce sont des erreurs de méthode, de communication ou de timing.",
                blog_migration_s8_table_h_erreur: "Erreur",
                blog_migration_s8_table_h_consequence: "Conséquence",
                blog_migration_s8_table_h_solution: "Solution",
                blog_migration_s8_row1_erreur: "Sauter l'audit pré-migration",
                blog_migration_s8_row1_consequence: "Données corrompues importées dans le coffre-fort",
                blog_migration_s8_row1_solution: "Toujours auditer, même si « on connaît nos données »",
                blog_migration_s8_row2_erreur: "Migrer sans jeu de test",
                blog_migration_s8_row2_consequence: "Découverte des problèmes en production",
                blog_migration_s8_row2_solution: "Coffre-fort de test obligatoire",
                blog_migration_s8_row3_erreur: "Garder l'ancien serveur accessible",
                blog_migration_s8_row3_consequence: "Double-système, retour aux vieilles habitudes",
                blog_migration_s8_row3_solution: "Couper l'accès J+1, archiver en lecture seule",
                blog_migration_s8_row4_erreur: "Former trop tôt (semaines avant la bascule)",
                blog_migration_s8_row4_consequence: "Les utilisateurs oublient tout entre la formation et le jour J",
                blog_migration_s8_row4_solution: "Former le jour même, sur leurs données réelles",
                blog_migration_s8_row5_erreur: "Ignorer la conduite du changement",
                blog_migration_s8_row5_consequence: "Rejet, contournements, fichiers hors coffre-fort",
                blog_migration_s8_row5_solution: "Identifier les « champions » en amont, impliquer les utilisateurs",
                blog_migration_s8_row6_erreur: "Sous-dimensionner le serveur PDM",
                blog_migration_s8_row6_consequence: "Performances dégradées = rejet immédiat",
                blog_migration_s8_row6_solution: "Dimensionner pour le volume cible à 3 ans, pas le volume actuel",
                blog_migration_s8_row7_erreur: "Pas de support post-migration",
                blog_migration_s8_row7_consequence: "Taux d'adoption chute sous 30 % en 3 mois",
                blog_migration_s8_row7_solution: "30 jours de support minimum, présence quotidienne S1-S2",
                blog_migration_s8_quote: "L'erreur n°3 est de loin la plus fréquente. J'ai vu des entreprises investir 6 mois dans un projet PDM et laisser l'ancien serveur Windows ouvert « au cas où ». Trois mois plus tard, 60 % des fichiers étaient encore créés hors coffre-fort. La migration avait échoué — non pas techniquement, mais humainement.",
                blog_migration_cta_title: "Vous avez trouvé cet article utile ?",
                blog_migration_cta_text: "La migration vers un PDM est le projet qui fait peur à tout le monde — mais avec la bonne méthode, c'est aussi celui qui transforme durablement un bureau d'études. Si vous préparez une migration ou si vous voulez échanger sur votre situation, n'hésitez pas.",
                blog_migration_cta_button: "Me contacter"
            }
        }
    },
    en: {
        ...
        articles: {
            ...
            "nomenclature-bom-pdm-plm-erp": {
                ...
                blog_bom_s7_p1: "After 80+ clients and 100+ PDM projects, here are the recurring symptoms I observe when PDM, PLM and ERP don't speak the same language:",
            ...
            "migration-donnees-solidworks-pdm": {
                blog_migration_badge_type: "SOLIDWORKS PDM",
                blog_migration_hero_eyebrow: "Migration &amp; data recovery",
                blog_migration_hero_title: "Data migration to SOLIDWORKS PDM: the field guide to succeed without losing a single file",
                blog_migration_hero_subtitle: `Published on <span data-date-iso="2026-03-18T00:00:00.000Z" data-date-format="long">March 18, 2026</span> — complete methodology, common pitfalls, and lessons learned from 80+ industrial migrations.`,
                blog_migration_stat_publication: "Publication date",
                blog_migration_stat_phases: "Migration phases",
                blog_migration_stat_projects: "Projects completed",
                blog_migration_hero_figcaption: "Migrating to a PDM vault means moving from organised chaos on a file server to a traced, versioned and secured data architecture.",
                blog_migration_summary_label1: "Why migrate to a PDM?",
                blog_migration_summary_meta1: "File server pain points",
                blog_migration_summary_label2: "Phase 1: Audit existing data",
                blog_migration_summary_meta2: "Mapping, naming, orphan references",
                blog_migration_summary_label3: "Phase 2: Define the recovery strategy",
                blog_migration_summary_meta3: "Big bang, progressive, or hybrid?",
                blog_migration_summary_label4: "Phase 3: Clean and prepare the data",
                blog_migration_summary_meta4: "Renaming, duplicates, broken references",
                blog_migration_summary_label5: "Phase 4: The technical migration",
                blog_migration_summary_meta5: "Tools, test set, validation",
                blog_migration_summary_label6: "Phase 5: Train and switch over",
                blog_migration_summary_meta6: "Human support and D-day",
                blog_migration_summary_label7: "Phase 6: Stabilise and optimise",
                blog_migration_summary_meta7: "Support, KPIs, continuous improvement",
                blog_migration_summary_label8: "The 7 mistakes I see on every project",
                blog_migration_summary_meta8: "And how to avoid them",
                blog_migration_s1_title: "1. Why migrate to a PDM?",
                blog_migration_s1_p1: "Most of the industrial design offices I work with still rely on a <strong>Windows file server</strong>: a folder tree, a naming convention that's more or less respected, and an Excel spreadsheet acting as a \"management system\". It works — until the day it doesn't.",
                blog_migration_s1_p2: "The tipping point always comes at the same moment: when a drafter overwrites a colleague's work, when an old revision goes to production, or when the technical director realises he has no idea where the drawings are for a product shipped 6 months ago.",
                blog_migration_s1_quote: "At a special-purpose machinery manufacturer, a 12-person design team was wasting an average of 45 minutes per day searching for \"the right version\" of a file. Multiply by 12 people and 220 working days — that's the equivalent of 2.5 full-time positions lost every year in non-value work.",
                blog_migration_s1_card1_title: "File server pain points",
                blog_migration_s1_card1_item1: "No file locking: two people editing the same file simultaneously",
                blog_migration_s1_card1_item2: "No versioning: copies named \"v2_final_REAL_def\" everywhere",
                blog_migration_s1_card1_item3: "Broken references: a moved file = a broken SOLIDWORKS assembly",
                blog_migration_s1_card1_item4: "No traceability: who changed what, when, why?",
                blog_migration_s1_card1_item5: "Fragile backup: one ransomware and everything is gone",
                blog_migration_s1_card2_title: "What SOLIDWORKS PDM brings",
                blog_migration_s1_card2_item1: "Check-in / Check-out: only one user edits at a time",
                blog_migration_s1_card2_item2: "Automatic versioning with full history",
                blog_migration_s1_card2_item3: "SQL vault: guaranteed referential integrity",
                blog_migration_s1_card2_item4: "Approval workflows: traced and compliant validation",
                blog_migration_s1_card2_item5: "Replicas and built-in backups: business continuity",
                blog_migration_s2_title: "2. Phase 1: Audit existing data",
                blog_migration_s2_p1: "<strong>Never trust existing data.</strong> That's my principle #2, and it's why every migration starts with an exhaustive audit. The goal: build a precise map of what exists, in what state, and with what dependencies.",
                blog_migration_s2_p2: "A well-run audit answers four questions: how many files? What formats? What naming conventions? And above all: what are the orphan references — those files pointed to by assemblies but that no longer exist or have been moved?",
                blog_migration_s2_table_h_point: "Checkpoint",
                blog_migration_s2_table_h_question: "Key question",
                blog_migration_s2_table_h_tool: "Tool / Method",
                blog_migration_s2_table_h_risk: "Risk if ignored",
                blog_migration_s2_row1_point: "<strong>Volume</strong>",
                blog_migration_s2_row1_question: "How many CAD, PDF, Office files?",
                blog_migration_s2_row1_tool: "PowerShell script / TreeSize",
                blog_migration_s2_row1_risk: "Underestimated scope, blown schedule",
                blog_migration_s2_row2_point: "<strong>Naming</strong>",
                blog_migration_s2_row2_question: "Is there a convention? Is it respected?",
                blog_migration_s2_row2_tool: "Regex + manual review",
                blog_migration_s2_row2_risk: "Duplicate part numbers in the vault",
                blog_migration_s2_row3_point: "<strong>References</strong>",
                blog_migration_s2_row3_question: "Which assemblies point to missing files?",
                blog_migration_s2_row3_tool: "SOLIDWORKS → Open read-only + verify",
                blog_migration_s2_row3_risk: "Broken assemblies in PDM from day 1",
                blog_migration_s2_row4_point: "<strong>Duplicates</strong>",
                blog_migration_s2_row4_question: "Same parts stored in multiple locations?",
                blog_migration_s2_row4_tool: "MD5 hash comparison / name + size",
                blog_migration_s2_row4_risk: "Version conflicts post-migration",
                blog_migration_s2_row5_point: "<strong>Metadata</strong>",
                blog_migration_s2_row5_question: "Are SOLIDWORKS properties filled in?",
                blog_migration_s2_row5_tool: "#TASK or VBA extraction macro",
                blog_migration_s2_row5_risk: "Empty PDM data cards, search impossible",
                blog_migration_s2_callout: "On average, across 80+ audits I've conducted, <strong>15 to 30% of files</strong> have at least one anomaly (duplicate, broken reference, non-compliant naming). Skipping this phase means importing chaos into a system designed for order.",
                blog_migration_s3_title: "3. Phase 2: Define the recovery strategy",
                blog_migration_s3_p1: "This is the most structuring decision of the project. Three approaches exist, each with its advantages and constraints. The choice depends on data volume, team maturity, and tolerance for design office downtime.",
                blog_migration_s3_card1_title: "Big Bang",
                blog_migration_s3_card1_item1: "<strong>Principle:</strong> migrate everything at once, over a weekend or during a shutdown",
                blog_migration_s3_card1_item2: "<strong>Advantage:</strong> no dual system, clean transition",
                blog_migration_s3_card1_item3: "<strong>Risk:</strong> if it crashes, everyone is stuck Monday morning",
                blog_migration_s3_card1_item4: "<strong>Ideal for:</strong> < 50,000 files, team < 10 people",
                blog_migration_s3_card2_title: "Progressive (batch)",
                blog_migration_s3_card2_item1: "<strong>Principle:</strong> migrate project by project or family by family",
                blog_migration_s3_card2_item2: "<strong>Advantage:</strong> controlled risk, iterative learning",
                blog_migration_s3_card2_item3: "<strong>Risk:</strong> dual system for weeks/months",
                blog_migration_s3_card2_item4: "<strong>Ideal for:</strong> > 100,000 files, team > 20 people",
                blog_migration_s3_card3_title: "Hybrid (my preferred approach)",
                blog_migration_s3_card3_item1: "<strong>Principle:</strong> migrate active projects via Big Bang, then ingest history progressively",
                blog_migration_s3_card3_item2: "<strong>Advantage:</strong> the design office works in PDM from day 1, history follows without pressure",
                blog_migration_s3_card3_item3: "<strong>Risk:</strong> requires fine management of cross-references between active/historical data",
                blog_migration_s3_card3_item4: "<strong>Ideal for:</strong> the majority of industrial SMEs",
                blog_migration_s3_card4_title: "Selection criteria",
                blog_migration_s3_card4_item1: "Total CAD file volume",
                blog_migration_s3_card4_item2: "Number of concurrent users",
                blog_migration_s3_card4_item3: "Tolerance for design office downtime",
                blog_migration_s3_card4_item4: "Complexity of cross-project references",
                blog_migration_s3_quote: "On an industrial project, we migrated 180,000 files using the hybrid approach: the 3 active projects switched over on a Friday evening, and the history (12 years of data) was ingested progressively over 3 weeks. Monday morning, all 15 drafters were working in the vault. Zero downtime.",
                blog_migration_s4_title: "4. Phase 3: Clean and prepare the data",
                blog_migration_s4_p1: "This is the most thankless phase — and the most critical. Migrating dirty data into a PDM vault is exactly like moving into a new apartment while bringing every unsorted box from the attic. The mess follows you.",
                blog_migration_s4_p2: "Cleaning happens in three passes: <strong>reference correction</strong> (moved or renamed files that break assemblies), <strong>duplicate elimination</strong> (same part stored in 3 different folders), and <strong>metadata enrichment</strong> (filling in SOLIDWORKS properties to feed PDM data cards).",
                blog_migration_s4_card1_title: "Cleaning tools",
                blog_migration_s4_card1_item1: "<strong>#TASK:</strong> bulk automation of file properties",
                blog_migration_s4_card1_item2: "<strong>SOLIDWORKS Utilities:</strong> geometric duplicate detection",
                blog_migration_s4_card1_item3: "<strong>PowerShell scripts:</strong> bulk renaming, path correction",
                blog_migration_s4_card1_item4: "<strong>Pack & Go:</strong> assembly repackaging with corrected references",
                blog_migration_s4_card2_title: "Golden rules",
                blog_migration_s4_card2_item1: "Never clean production data — always work on a copy",
                blog_migration_s4_card2_item2: "Validate each batch with the design team before moving on",
                blog_migration_s4_card2_item3: "Document every renaming rule (the team must be able to trace back)",
                blog_migration_s4_card2_item4: "Plan a \"sandbox\" for unclassifiable files",
                blog_migration_summary_label4b: "Behind the scenes: my field toolkit",
                blog_migration_summary_meta4b: "DataRecovery, FindDocuments, Dependencies, sync workflows",
                blog_migration_s4b_title: "Behind the scenes: my field toolkit",
                blog_migration_s4b_p1: "Theory is great, but what makes the difference between a migration that succeeds and one that derails are the tools and automations. Here's concretely what I use in the field, step by step. Each tool has a precise role in the chain — skipping a step means risking contamination of the entire vault.",
                blog_migration_s4b_table_h_etape: "Step",
                blog_migration_s4b_table_h_outil: "Tool",
                blog_migration_s4b_table_h_action: "What it does",
                blog_migration_s4b_table_h_resultat: "Concrete result",
                blog_migration_s4b_row1_action: "Copies Windows files into the PDM vault and bulk-extracts SOLIDWORKS properties into an Excel file",
                blog_migration_s4b_row1_resultat: "An Excel file with all paths, internal references (REF_INT), revision indices and file types",
                blog_migration_s4b_row2_action: "Automatic analysis: REF_INT extraction, latest revision detection, duplicate identification, invalid indices and group contamination",
                blog_migration_s4b_row2_resultat: "Each file classified into 3 categories: <strong>YES</strong> (rename), <strong>NO</strong> (archive), <strong>ALERT</strong> (manual treatment)",
                blog_migration_s4b_row3_action: "Builds a SQLite database of all SOLIDWORKS documents and bulk-renames <strong>outside the vault</strong>, without breaking reference links — essential on PDM Standard where the API doesn't allow in-vault renaming",
                blog_migration_s4b_row3_resultat: "All files with RENAME=YES renamed with their REF_INT before vault injection, links intact between assemblies and parts",
                blog_migration_s4b_row4_action: "Detects and lists true duplicates in the vault (same reference + same index)",
                blog_migration_s4b_row4_resultat: "Clean list, duplicates removed before moving to link restoration",
                blog_migration_s4b_row5_action: "Analyses and corrects broken references in SOLIDWORKS assemblies — finds the file in the vault and restores the link",
                blog_migration_s4b_row5_resultat: "Zero red crosses when opening assemblies. Run a second time to verify",
                blog_migration_s4b_row6_action: "Automatic transition in the PDM workflow: synchronises the revision counter with the index in the data card (A→B→C…Z)",
                blog_migration_s4b_row6_resultat: "Consistent version history in the vault, every file has its correct index",
                blog_migration_s4b_row7_action: "Bulk renaming <strong>directly inside the vault</strong> via the PDM API — available only on PDM Professional. Chains multiple actions (serial numbers, renaming, conversion, PDF stamping) during workflow transitions",
                blog_migration_s4b_row7_resultat: "Renaming driven by data card variables, with automatic unique reference generation (SmartCounter)",
                blog_migration_s4b_quote: "On a migration project from 3DEXPERIENCE to SOLIDWORKS PDM, the challenge: file names in 3DX didn't match physical file names. We had to build a mapping table using the Part Number as the linking key. DataRecovery extracts PDM paths, we cross-reference with the 3DX bill of materials, and the Excel file automatically generates the correct paths for property injection. Without this step, we would have assigned wrong metadata to hundreds of files.",
                blog_migration_s4b_p2: "The crucial point I want to emphasise: <strong>these tools are not optional.</strong> Each step in the chain produces the deliverable needed for the next step. DataRecovery feeds the analysis Excel file, which drives FindDocuments, which prepares the ground for Dependencies. Skip a step — for example renaming without analysing — and you contaminate the entire chain. I've seen migrations restarted from scratch because the cleanup was rushed.",
                blog_migration_s4b_callout: "On a data recovery project, the analysis Excel file automatically classified each file into three categories: <strong>YES</strong> (latest valid revision, rename with REF_INT), <strong>NO</strong> (old revision, archive), and <strong>ALERT</strong> (invalid reference, duplicate or non-compliant index — manual treatment). This automated sorting handled 95% of files without human intervention. Only the 5% flagged as ALERT required case-by-case examination — checking usage, correcting the card, then archiving or renaming.",
                blog_migration_s4b_rev_title: "Focus: how we recover and synchronise revision indices",
                blog_migration_s4b_rev_p1: "This is the question everyone asks — and the one where most migrations go off the rails. When a file is named <code>SPF-AC8602-Part-B.SLDPRT</code>, the \"B\" at the end is the revision index. You don't guess it: you <strong>extract</strong> it, either from the file name (pattern like <code>XXX-LLnnnn-Name-INDEX.ext</code>), or from a custom SOLIDWORKS property (\"Revision\" or \"Index\" metadata in the data card). In both cases, the analysis Excel file does the extraction work.",
                blog_migration_s4b_rev_p2: "<strong>Fundamental rule: only the latest revision is actively migrated.</strong> If for the same reference <code>SPF-AC8602</code> files A, B and C exist, only the file at index C will be renamed and integrated as an active document in the vault (category <strong>YES</strong>). Files A and B are kept but sent to <strong>ARCHIVE</strong> state in the PDM workflow — they remain accessible for history, but don't clutter the current workspace.",
                blog_migration_s4b_rev_extract_title: "Index extraction",
                blog_migration_s4b_rev_extract1: "<strong>From the name:</strong> the Excel script parses the file name and isolates the letter (A-Z) in the last position before the extension",
                blog_migration_s4b_rev_extract2: "<strong>From metadata:</strong> DataRecovery reads the \"Revision\" or \"Index\" property from SOLIDWORKS custom properties",
                blog_migration_s4b_rev_extract3: "<strong>Drawing files (SLDDRW):</strong> the drawing inherits the REF_INT and index from its associated 3D model (same file name). If no 3D is found, direct extraction from the drawing name",
                blog_migration_s4b_rev_sync_title: "Synchronisation in PDM",
                blog_migration_s4b_rev_sync1: "<strong>\"VALIDATE RECOVERY\" transition:</strong> a special transition is configured in the PDM workflow to align the revision counter",
                blog_migration_s4b_rev_sync2: "<strong>Pass by index:</strong> we execute the transition for files at index A (increment = 0), then B (increment = 1), then C (increment = 2)… up to Z",
                blog_migration_s4b_rev_sync3: "<strong>Result:</strong> the internal PDM counter matches exactly the actual file index — the index increment will work normally from then on",
                blog_migration_s4b_rev_callout: "<strong>Special case — Workgroup to PDM migration:</strong> files with \"$\" or \"$+\" revisions (Workgroup notation) keep these values in PDM. On the first transition to \"MODIFY WITH INDEX\", they automatically switch to \"A\". Files already at A/B/C are aligned to their index and evolve normally. Intermediate revisions (\"A+\", \"B+\") require manual treatment to be properly realigned before standard index increment.",
                blog_migration_s4b_dup_title: "Focus: duplicate management — the silent poison of a migration",
                blog_migration_s4b_dup_p1: "Duplicates are the most underestimated problem in a migration. A duplicate is a file with the <strong>same reference (REF_INT) + same type + same index</strong> that exists in multiple locations. On some projects, I've seen over <strong>40,000 duplicates</strong> in a single vault — often generated by poorly configured tree copies or approximate manual renames accumulated over years.",
                blog_migration_s4b_dup_p2: "The problem isn't just disk space. A duplicate creates <strong>ambiguity</strong>: which file is the right one? The one in the \"Project_2023\" folder or the one in \"Old_Archive\"? Which one does the assembly point to? Without treatment, you're importing chaos into the vault — and multiplying it.",
                blog_migration_s4b_dup_detect_title: "Detection with PDMreport",
                blog_migration_s4b_dup_detect1: "<strong>Duplicate report:</strong> PDMreport (via myPDMtools) generates a CSV report listing all duplicated files — same reference, same index, different locations",
                blog_migration_s4b_dup_detect2: "<strong>Batch analysis:</strong> process folder by folder, starting with import folders. Each duplicate is examined: creation date, last modification, incoming references",
                blog_migration_s4b_dup_detect3: "<strong>Rule:</strong> always keep the most recent version and verify reference integrity after each deletion",
                blog_migration_s4b_dup_prevent_title: "Post-migration prevention",
                blog_migration_s4b_dup_prevent1: "<strong>PDM setting:</strong> enable the duplicate file name prohibition in the vault settings — this is the first thing to do after migration",
                blog_migration_s4b_dup_prevent2: "<strong>Tree copy:</strong> configure exclusion filters (standard parts library, purchased components) to prevent each new project from duplicating the same parts",
                blog_migration_s4b_dup_prevent3: "<strong>Automatic renaming:</strong> combine TaskActions + SmartCounter so each new file automatically receives a unique reference — zero manual entry, zero duplicates",
                blog_migration_s4b_dup_callout: "<strong>Critical order:</strong> duplicate removal must happen <strong>after</strong> renaming (FindDocuments) and <strong>before</strong> link restoration (Dependencies). Why? Because if you fix references while duplicates still exist, Dependencies may point to the wrong file. And once a link is created, it's much more expensive to fix. The sequence rename → deduplicate → restore links isn't a methodological detail, it's a quality gate.",
                blog_migration_s4b_rename_title: "Focus: bulk renaming — inside or outside the vault?",
                blog_migration_s4b_rename_p1: "This is a question I get every time: <em>\"can we rename directly inside the vault?\"</em> The answer depends on your PDM version. This is often misunderstood, and it determines the entire recovery strategy.",
                blog_migration_s4b_rename_pro_title: "PDM Professional — renaming inside the vault",
                blog_migration_s4b_rename_pro1: "<strong>API available:</strong> PDM Professional has a full programming API that allows renaming files directly inside the vault, without extracting or reimporting",
                blog_migration_s4b_rename_pro2: "<strong>TaskActions (myPDMtools):</strong> chains actions during workflow transitions — serial number generation (SmartCounter), automatic renaming based on data card variables, conversion, PDF stamping",
                blog_migration_s4b_rename_pro3: "<strong>Advantage:</strong> renaming happens on files already in the vault, with automatic update of all PDM references. No risk of desynchronisation",
                blog_migration_s4b_rename_std_title: "PDM Standard — renaming outside the vault",
                blog_migration_s4b_rename_std1: "<strong>No API:</strong> on PDM Standard, the PDM API is not available. Tools like myPDMtools (TaskActions) don't work — impossible to rename inside the vault via script",
                blog_migration_s4b_rename_std2: "<strong>FindDocuments (mycadtools):</strong> the solution is to build a SQLite database of all SOLIDWORKS documents <em>before</em> copying them into the vault. FindDocuments bulk-renames while updating internal reference links — without breaking a single assembly",
                blog_migration_s4b_rename_std3: "<strong>Sequence:</strong> rename first on the local file system, then inject already-clean files into the vault. The vault receives ready-to-use data",
                blog_migration_s4b_rename_callout: "<strong>In summary:</strong> with <strong>PDM Professional</strong>, you rename inside the vault using the API (TaskActions + SmartCounter). With <strong>PDM Standard</strong>, you rename outside the vault with FindDocuments (SQLite database) before injecting files. In both cases, the goal is identical: every file carries its correct reference, and no assembly link is broken. The tool choice depends on your licence — not the methodology.",
                blog_migration_s5_title: "5. Phase 4: The technical migration",
                blog_migration_s5_p1: "This is the moment when data leaves the file server to enter the PDM vault. This phase is purely technical, but it must be executed with surgical precision. One forgotten file or one poorly resolved reference, and it's an assembly opening with red crosses on Monday morning.",
                blog_migration_s5_p2: "The key: <strong>always do a dry run.</strong> I select a representative test set (3 to 5 projects covering different assembly types, sizes, complexities) and migrate them into a test vault. The team validates. If everything is green, we launch the production migration.",
                blog_migration_s5_table_h_etape: "Step",
                blog_migration_s5_table_h_action: "Action",
                blog_migration_s5_table_h_validation: "Validation",
                blog_migration_s5_row1_action: "Create the target folder structure in the vault",
                blog_migration_s5_row1_validation: "Structure compliant with specifications",
                blog_migration_s5_row2_action: "Migrate the test set (3-5 projects)",
                blog_migration_s5_row2_validation: "Assemblies open without errors",
                blog_migration_s5_row3_action: "Validation by the design team on the test set",
                blog_migration_s5_row3_validation: "Signed validation report",
                blog_migration_s5_row4_action: "Production migration (outside business hours)",
                blog_migration_s5_row4_validation: "Source file count = target file count",
                blog_migration_s5_row5_action: "Post-migration check: references, metadata, workflows",
                blog_migration_s5_row5_validation: "20-point verification checklist",
                blog_migration_s5_row6_action: "Cut access to the source file server",
                blog_migration_s5_row6_validation: "No silent rollback possible",
                blog_migration_s5_callout: "Critical point: step 6 is scary, but it's essential. If you leave the old server accessible, users will quietly go back to their old habits. <strong>You can't be half-in a PDM.</strong>",
                blog_migration_s6_title: "6. Phase 5: Train and switch over",
                blog_migration_s6_p1: "This is where 80% of PDM projects are won or lost — and where most fail. A technically perfect migration is worthless if users don't understand the \"why\" and the \"how\" of the new system. People before tools, always.",
                blog_migration_s6_card1_title: "Administrator training",
                blog_migration_s6_card1_item1: "Upstream of migration (2-3 weeks before)",
                blog_migration_s6_card1_item2: "Vault architecture, workflows, permissions",
                blog_migration_s6_card1_item3: "Troubleshooting common issues (locked files, inconsistent states)",
                blog_migration_s6_card1_item4: "Train them on THEIR data, not on a generic dataset",
                blog_migration_s6_card2_title: "User training",
                blog_migration_s6_card2_item1: "Same day or the day after the switch",
                blog_migration_s6_card2_item2: "Check-in, Check-out, search, state change",
                blog_migration_s6_card2_item3: "Hands-on workshops on their real projects",
                blog_migration_s6_card2_item4: "Quick reference: laminated A4 cheat sheet",
                blog_migration_s6_quote: "The reluctant drafter is my go-to story. A senior with 25 years of experience who categorically refused to \"put his files in a black box\". I showed him one thing: type 3 letters in PDM search and find a drawing in 2 seconds, where he used to open 6 subfolders for 3 minutes. He became the project's biggest ambassador.",
                blog_migration_s7_title: "7. Phase 6: Stabilise and optimise",
                blog_migration_s7_p1: "The first 30 days post-migration are critical. That's when old habits try to come back, questions pile up, and small irritants can turn into massive rejection if nobody is there to address them.",
                blog_migration_s7_card1_title: "Weeks 1-2: Intensive support",
                blog_migration_s7_card1_item1: "On-site presence or daily video calls",
                blog_migration_s7_card1_item2: "Ticket resolution in < 2 hours",
                blog_migration_s7_card1_item3: "Workflow adjustments if needed",
                blog_migration_s7_card1_item4: "Daily debrief with the PDM admin",
                blog_migration_s7_card2_title: "Weeks 3-4: Empowerment",
                blog_migration_s7_card2_item1: "PDM admin takes over as first line",
                blog_migration_s7_card2_item2: "Tracking KPIs: adoption rate, unarchived files",
                blog_migration_s7_card2_item3: "Lessons learned session with the team",
                blog_migration_s7_card2_item4: "Optimisation roadmap (phase 2: ERP integration, dispatch…)",
                blog_migration_s8_title: "8. The 7 mistakes I see on every project",
                blog_migration_s8_p1: "After 80+ migration projects, certain patterns come up systematically. They're rarely technical problems — they're mistakes in method, communication, or timing.",
                blog_migration_s8_table_h_erreur: "Mistake",
                blog_migration_s8_table_h_consequence: "Consequence",
                blog_migration_s8_table_h_solution: "Solution",
                blog_migration_s8_row1_erreur: "Skipping the pre-migration audit",
                blog_migration_s8_row1_consequence: "Corrupted data imported into the vault",
                blog_migration_s8_row1_solution: "Always audit, even if \"we know our data\"",
                blog_migration_s8_row2_erreur: "Migrating without a test set",
                blog_migration_s8_row2_consequence: "Problems discovered in production",
                blog_migration_s8_row2_solution: "Test vault is mandatory",
                blog_migration_s8_row3_erreur: "Keeping the old server accessible",
                blog_migration_s8_row3_consequence: "Dual system, return to old habits",
                blog_migration_s8_row3_solution: "Cut access D+1, archive as read-only",
                blog_migration_s8_row4_erreur: "Training too early (weeks before the switch)",
                blog_migration_s8_row4_consequence: "Users forget everything between training and D-day",
                blog_migration_s8_row4_solution: "Train on the same day, on their real data",
                blog_migration_s8_row5_erreur: "Ignoring change management",
                blog_migration_s8_row5_consequence: "Rejection, workarounds, files outside the vault",
                blog_migration_s8_row5_solution: "Identify \"champions\" upstream, involve users",
                blog_migration_s8_row6_erreur: "Undersizing the PDM server",
                blog_migration_s8_row6_consequence: "Degraded performance = immediate rejection",
                blog_migration_s8_row6_solution: "Size for the 3-year target volume, not the current one",
                blog_migration_s8_row7_erreur: "No post-migration support",
                blog_migration_s8_row7_consequence: "Adoption rate drops below 30% in 3 months",
                blog_migration_s8_row7_solution: "Minimum 30 days of support, daily presence W1-W2",
                blog_migration_s8_quote: "Mistake #3 is by far the most common. I've seen companies invest 6 months in a PDM project and leave the old Windows server open \"just in case\". Three months later, 60% of files were still being created outside the vault. The migration had failed — not technically, but humanly.",
                blog_migration_cta_title: "Found this article useful?",
                blog_migration_cta_text: "Migrating to a PDM is the project that scares everyone — but with the right method, it's also the one that durably transforms a design office. If you're preparing a migration or want to discuss your situation, don't hesitate.",
                blog_migration_cta_button: "Contact Me"
            }
        }
    }
};
