    ...
    fr: {
        ...
        articles: {
            ...
            "migration-donnees-solidworks-pdm": {
                ...
                blog_migration_s4b_row3_action: "Construit une base SQLite de tous les fichiers SOLIDWORKS et renomme en masse sans casser les liens de références",
                blog_migration_s4b_row3_resultat: "Tous les fichiers RENOMMAGE=OUI renommés avec leur REF_INT, liens intacts entre assemblages et pièces",
                ...
                blog_migration_s4b_row7_action: "Tâche paramétrée dans MyPDMtools pour renommer les fichiers directement dans le coffre en se basant sur les variables de carte",
                blog_migration_s4b_row7_resultat: "Renommage piloté par les métadonnées, avec nouvelle référence si besoin",
    ...
    en: {
        ...
        articles: {
            ...
            "migration-donnees-solidworks-pdm": {
                ...
                blog_migration_s4b_row3_action: "Builds a SQLite database of all SOLIDWORKS files and bulk-renames without breaking reference links",
                blog_migration_s4b_row3_resultat: "All files with RENAME=YES renamed with their REF_INT, links intact between assemblies and parts",
                ...
                blog_migration_s4b_row7_action: "Task configured in MyPDMtools to rename files directly in the vault based on data card variables",
                blog_migration_s4b_row7_resultat: "Metadata-driven renaming, with new reference if needed",
