    ...
    fr: {
        ...
        articles: {
            ...
            "migration-donnees-solidworks-pdm": {
                ...
                blog_migration_s4b_quote: "Sur le projet Enchanted Tools, on migrait depuis 3DEXPERIENCE vers SOLIDWORKS PDM. Le défi : les noms de fichiers dans 3DX ne correspondaient pas aux noms physiques. On a dû construire une table de correspondance via le Part Number comme clé de liaison. DataRecovery extrait les chemins PDM, on croise avec la nomenclature 3DX, et le fichier Excel génère automatiquement les bons chemins pour l'injection des propriétés. Sans cette étape, on aurait attribué les mauvaises métadonnées à des centaines de fichiers.",
                ...
                blog_migration_s5_row5_validation: "Checklist de 20 points (fournie par Visiativ)",
    ...
    en: {
        ...
        articles: {
            ...
            "migration-donnees-solidworks-pdm": {
                ...
                blog_migration_s3_quote: "On the Pandrol project, we migrated 180,000 files using the hybrid approach: the 3 active projects switched over on a Friday evening, and the history (12 years of data) was ingested progressively over 3 weeks. Monday morning, all 15 drafters were working in the vault. Zero downtime.",
                ...
                blog_migration_s5_row5_validation: "20-point checklist (provided by Visiativ)",
